...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { correct: @choice.correct, points: @choice.points, prop_id: @choice.prop_id, title: @choice.title } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { correct: @choice.correct, points: @choice.points, prop_id: @choice.prop_id, title: @choice.title } }
