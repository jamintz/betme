...
class PropsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prop" do
    assert_difference('Prop.count') do
      post props_url, params: { prop: { active: @prop.active, game_id: @prop.game_id, title: @prop.title } }
    end
  ...
  test "should update prop" do
    patch prop_url(@prop), params: { prop: { active: @prop.active, game_id: @prop.game_id, title: @prop.title } }
