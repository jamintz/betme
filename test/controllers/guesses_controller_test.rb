...
class GuessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guess" do
    assert_difference('Guess.count') do
      post guesses_url, params: { guess: { correct: @guess.correct, prop_id: @guess.prop_id, title: @guess.title } }
    end
  ...
  test "should update guess" do
    patch guess_url(@guess), params: { guess: { correct: @guess.correct, prop_id: @guess.prop_id, title: @guess.title } }
